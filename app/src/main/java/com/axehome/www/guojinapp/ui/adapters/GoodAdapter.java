...
public class GoodAdapter extends BaseAdapter {
    ...
    public GoodAdapter(Activity context, List<PreGoodsBean> mList, VipListenter listenter) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(mList.get(position).getGood_type().equals("2")){
            holder.tvJifenValue.setVisibility(View.VISIBLE);
            holder.tvJifenValue.setText("所需积分："+mList.get(position).getGood_jifen());
        }
        return convertView;
    }
