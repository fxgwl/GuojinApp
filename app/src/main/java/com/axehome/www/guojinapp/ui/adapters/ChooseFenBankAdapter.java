...
public class ChooseFenBankAdapter extends BaseAdapter {
    private Activity context;
    private List<BankBean> mList;
    public ChooseFenBankAdapter(Activity context, List<BankBean> mList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.tvText.setText(mList.get(position).getZhi_hang_name());
        /*if(type==1){
