...
public class GoodZiQiangAdapter extends BaseAdapter {
    private Context context;
    private List<PreGoodsBean> mList;
    private VipListenter listenter;

    public GoodZiQiangAdapter(Context context, List<PreGoodsBean> mList,VipListenter listenter) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(
                    R.layout.item_good_ziqiang, parent, false);
