...
/**
 * Created by Axehome_Mr.z on 2020/8/28 17:04
 */
public class MyWeekView extends WeekView {
    ...
    protected boolean onDrawSelected(Canvas canvas, Calendar calendar, int x, boolean hasScheme) {
        ...
        mSelectedPaint.setColor(getResources().getColor(R.color.white));
        //canvas.drawRect(x + mPadding, mPadding, x + mItemWidth - mPadding, mItemHeight - mPadding, mSelectedPaint);
        canvas.drawCircle(x+mItemWidth/2,mItemHeight/2,(mItemWidth-20)/2,mSelectedPaint);
        return true;
    }
